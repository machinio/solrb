require 'solr/basic_response/header'
require 'solr/basic_response/http_status'
require 'solr/basic_response/solr_error'
require 'solr/basic_response/parser'

module Solr
  class BasicResponse
    def self.from_raw_response(response)
      Solr::BasicResponse::Parser.new(response).parse
    end
